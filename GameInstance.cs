...
public class GameInstance
{
    ...
    private void setup()
    {
        // Add Scenes to scenes List
        scenes.Add(new MainMenu());
        scenes.Add(new OptionsMenu());
        scenes.Add(new Level1());
        scenes.Add(new Level2());
        scenes.Add(new Level3());
        scenes.Add(new Level4());
        scenes.Add(new Level5());
        scenes.Add(new Level6());
        scenes.Add(new Level7());
        scenes.Add(new Level8());
        scenes.Add(new Level9());
        scenes.Add(new Level10());
    ...
    private void renderLoop()
    {
        ...
        new System.Threading.Thread(new System.Threading.ThreadStart(logicLoop)).Start();
